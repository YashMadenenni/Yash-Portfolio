    ...
    <>
      ...
      <div className="flex sm:flex-row flex-col mt-10">
        <motion.div
          ...
          className="about_img mx-auto bg-[#e1a154e2] mt-5"
          alt="user_image"
        ></motion.div>
        ...
        <div className=" sm:w-1/2 w-full text-justify px-5">
          ...
          >
              ...
              experience in various fields such as Java full stack, B2B and B2C services,
              web development, RESTful Services, and academic exposure to MERN
              (Mongo DB, Express JS, React, Node JS) stack projects. 
              <br/>
              <br/>
              Passionate about fitness, I enjoy hitting the gym and actively engage in
              various sports like cricket, badminton. On my downtime, you'll
              find me immersed in movies, anime, and constantly learning about
              new technologies.
          ...
          >
            ...
            focus:ring-4 
            focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 
            dark:shadow-lg dark:shadow-green-800/80 font-medium 
