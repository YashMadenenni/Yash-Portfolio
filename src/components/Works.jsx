...
const ProjectCard = ({
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.75, 2)} viewport={{ once: true, amount: 0.3}}>
      <Tilt
        options={{
          max: 45,
          scale: 1,
        ...
        dark:bg-gradient-to-r from-[#527886a3] via-[#4a7c8c8e] to-[#3e648ee2]  
        p-5 rounded-2xl sm:w-[360px] w-full h-[530px]"
      >
    ...
    <>
      ...
      <div className="w-full  justify-center sm:flex hidden ">
        <motion.p
          ...
          className="mt-1 text-secondary dark:text-white text-[17px] max-w-3xl leading-[30px]"
        >
